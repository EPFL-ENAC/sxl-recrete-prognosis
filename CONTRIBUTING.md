# EPFL-ENAC/sxl-recrete-prognosis Contributing Guide

Hi! Thanks for taking the time to contribute to EPFL-ENAC/sxl-recrete-prognosis.

_You can contribute in many ways_

- Join the [discussion](https://github.com/EPFL-ENAC/sxl-recrete-prognosis/discussions)

_Before submitting your contribution, please make sure to take a moment and read through the following guidelines_

- [Code of Conduct](https://github.com/EPFL-ENAC/sxl-recrete-prognosis/blob/main/CODE_OF_CONDUCT.md)
...
- Always use [ issue templates ](https://github.com/EPFL-ENAC/sxl-recrete-prognosis/issues/new/choose)
