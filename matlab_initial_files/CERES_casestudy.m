...
hsreuse=0.15; %épaisseur de la dalle de réemploi [m]
year=2; %1=depuis 1989; 2=entre 1968 et 1988 ; 3=entre 1956 et 1967
Q0=2; %charge utiles donneur [kN/m2]
Q1=3;%charge utiles recevru [kN/m2]
...
if steelprofile_type==2 %reusedsteel
    fyd=335/1.05; %Résistance profilé de réemploi à Malley [N/mm2]
...
if steelprofile_type==2 %reusedsteel
    data=xlsread('data_beams_casestudy.xlsx','1','B4:S5');
end
